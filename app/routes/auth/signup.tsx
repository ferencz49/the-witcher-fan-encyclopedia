    ...
    return(
        <>
            <div className="flex flex-col flex-1 items-center justify-center bg-black">
                <h1 className="text-3xl p-5 text-gray-300">Signup</h1>
                ...
                <p className="p-5 text-gray-300">Already have an account? <a href="/signin"><Button variant="ghost">Click here</Button></a></p>
            </div>
        </>
    )
}